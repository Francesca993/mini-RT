...
* Implementare un primo ray tracer semplice ma completo.
* Gestire camera, luce, ambient light e oggetti geometrici base:
	* Sphere (sp)
	* Plane (pl)
	* Cylinder (cy)
* Esercitarsi con:
	* parsing e validazione di un file di scena,
	* strutture dati ben progettate,
	* matematica 3D di base (vettori, raggi, intersezioni).
